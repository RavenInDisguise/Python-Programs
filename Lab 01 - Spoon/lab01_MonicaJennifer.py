...
# Fecha de última modificación: 20/05/2020 3:00pm
# Versión: 3.8.2
########################################################################
...
def validarCodigo(codigo1):
    ...
    if re.match("RE",codigo1[0:2]):
            if re.match(r"(RE)(D)[1|3-5]$",codigo1)or re.match(r"(RE)(S)[2|6]$",codigo1):
                opcion=1
            elif re.match(r"(RE)(S)(7)[1-2](PQ|MD|GD)$",codigo1):
                opcion=2
            else:
                opcion=5
