...
#Última modificación: 22/07/2020 22:00
#Versión 3.8.2
##########################################################################
...
2) Gaseosa
                                                                 ...
                                                                 if(validarTipoBebida(tipoBebidaFria)):
                                                                    ...
                                                                    while True:
                                                                        ...
                                                                        listaBebidas.append(bebidaFria)
                                                                        return False
                                                                 else:
...
4) Aguadulce
                                                                       """)
                                                             tipoBebidaCaliente=int(input("Ingrese el tipo de bebida: "))
                                                             if(validarBebidaCal(tipoBebidaCaliente)):
                                                                 while True:
                                                                    ...
                                                                    listaBebidas.append(bebidaCaliente)
                                                                    return False
                                                    else:
...
⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘⌘
        ...
        if (menuOpcion=="1"):
                ...
                menuPrincipal(listaBebida)         
        else:
            print("Esa opción no existe, ingrese otra.\n")
    return

def menuPrincipal(listaBebida):
    """
